...
const POPULAR_TICKERS = [
  ...
  {sym:'WMT',name:'Walmart Inc.'},{sym:'PG',name:'Procter & Gamble'},
  {sym:'MA',name:'Mastercard Inc.'},{sym:'UNH',name:'UnitedHealth Group'},
  {sym:'HD',name:'Home Depot Inc.'},{sym:'DIS',name:'Walt Disney Co.'},
  {sym:'BAC',name:'Bank of America'},{sym:'NFLX',name:'Netflix Inc.'},
  {sym:'ADBE',name:'Adobe Inc.'},{sym:'CRM',name:'Salesforce Inc.'},
  {sym:'PEP',name:'PepsiCo Inc.'},{sym:'KO',name:'Coca-Cola Co.'},
  {sym:'INTC',name:'Intel Corp.'},{sym:'AMD',name:'Advanced Micro Devices'},
  {sym:'CSCO',name:'Cisco Systems'},{sym:'NKE',name:'Nike Inc.'},
  {sym:'ABBV',name:'AbbVie Inc.'},{sym:'AVGO',name:'Broadcom Inc.'},
  {sym:'TXN',name:'Texas Instruments'},{sym:'QCOM',name:'Qualcomm Inc.'},
  {sym:'COST',name:'Costco Wholesale'},{sym:'PYPL',name:'PayPal Holdings'},
  {sym:'UBER',name:'Uber Technologies'},{sym:'SPY',name:'SPDR S&P 500 ETF'},
